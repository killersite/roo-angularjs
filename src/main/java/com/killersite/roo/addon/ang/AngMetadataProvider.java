...
/**
 * Provides {@link AngMetadata}. This type is called by Roo to retrieve the metadata for this add-on.
...
//                formBackingType.getFullyQualifiedTypeName());
    ...
    protected ItdTypeDetailsProvidingMetadataItem getMetadata(String metadataIdentificationString, JavaType aspectName, PhysicalTypeMetadata governorPhysicalTypeMetadata, String itdFilename) {
        ...
        return new AngMetadata(metadataIdentificationString, aspectName, governorPhysicalTypeMetadata);
    }
    
    /**
     * Define the unique ITD file name extension, here the resulting file name will be **_ROO_Ang.aj
     */
    ...
    protected String getGovernorPhysicalTypeIdentifier(String metadataIdentificationString) {
        JavaType javaType = AngMetadata.getJavaType(metadataIdentificationString);
        LogicalPath path = AngMetadata.getPath(metadataIdentificationString);
        return PhysicalTypeIdentifier.createIdentifier(javaType, path);
    }
    
    protected String createLocalIdentifier(JavaType javaType, LogicalPath path) {
        return AngMetadata.createIdentifier(javaType, path);
    }

    public String getProvidesType() {
        return AngMetadata.getMetadataIdentiferType();
    }
}